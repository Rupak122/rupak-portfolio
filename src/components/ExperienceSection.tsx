...
const TechBadge = ({ name }: TechBadgeProps) => {
  return (
    <Badge 
      variant="outline" 
      className="bg-blue-50 text-blue-600 border-blue-200 hover:bg-blue-100 dark:bg-blue-900/20 dark:border-blue-800 dark:text-blue-400 transition-all duration-300 hover:-translate-y-1 hover:shadow-sm"
    >
      {name}
    </Badge>
  );
...
const ExperienceCard = ({ 
  ...
  return (
    <RevealOnScroll threshold={0.1} delay={200} direction="right">
      <Card className="border-l-4 border-l-blue-600 bg-white dark:bg-slate-800/50 backdrop-blur-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 experience-card group overflow-hidden">
        ...
        <CardContent className="p-6 relative z-10">
          <div className="space-y-4">
            <div className="flex items-start justify-between">
              ...
              <div className="px-3 py-1 text-sm font-medium bg-blue-100 text-blue-600 rounded-full dark:bg-blue-900/30 flex items-center">
        ...
        <RevealOnScroll threshold={0.1}>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white relative inline-block">
              ...
              <span className="absolute -bottom-2 left-0 w-full h-1 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500"></span>
            </h2>
