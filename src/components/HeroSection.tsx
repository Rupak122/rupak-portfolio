        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
          ...
          <div className={`lg:col-span-2 flex justify-center lg:justify-end transform ${isVisible ? 'opacity-100' : 'opacity-0 translate-x-[-50px]'} transition-all duration-1000 ease-out`}>
            <div className="relative group">
              <div className="absolute -inset-0.5 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 opacity-70 group-hover:opacity-100 transition-opacity duration-700"></div>
          ...
          <div className="lg:col-span-3 space-y-8">
            <div className={`${isVisible ? 'opacity-100' : 'opacity-0 translate-y-[30px]'} transition-all duration-1000 ease-out delay-300`}>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white">
                ...
                <TypewriterText text="Rupak Kumar Singh" />
              </h1>
            </div>
            ...
            <div className={`flex flex-wrap gap-4 pt-2 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-[30px]'} transition-all duration-1000 ease-out delay-700`}>
              <Button asChild className="bg-blue-500 hover:bg-blue-600 text-white shadow-lg hover:shadow-blue-500/20 transition-all duration-300 border border-blue-400/30">
                <a href="#experience">
                  <Code size={16} className="mr-2" /> View Experience
                </a>
              </Button>
              
              <Button variant="outline" asChild className="border-blue-200 bg-white/50 text-blue-500 hover:bg-blue-50 hover:text-blue-600 transition-all duration-300 dark:border-blue-800 dark:bg-slate-900/50 dark:text-blue-400 dark:hover:bg-slate-800">
                <a href="#contact">
            ...
            {/* Terminal animation */}
            <div className={`font-mono text-sm text-slate-500 pt-4 ${isVisible ? 'opacity-100' : 'opacity-0'} transition-all duration-1000 ease-out delay-1000`}>
              <div className="flex items-center">
                <span className="text-blue-500">$</span>
                <span className="ml-2">figma start new_project</span>
